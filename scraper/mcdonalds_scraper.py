...
def scrape_mcdonalds_zomato():
    url = "https://www.zomato.com/ncr/mcdonalds-raj-nagar-extension-ghaziabad/order"
    ...
    df.to_csv("mcdonalds_raj_nagar_extension_menu.csv", index=False)
    print("Saved to mcdonalds_raj_nagar_extension_menu.csv")

if __name__ == "__main__":
    scrape_mcdonalds_zomato()
